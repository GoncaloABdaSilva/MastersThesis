...
class UNET(nn.Module):
    def __init__(
        ...
        self.ups.append(nn.ConvTranspose2d(features[3], features[2], kernel_size=2, stride=2))
        self.ups.append(DoubleConvWithDilation(features[3], features[2], 2))
        self.ups.append(nn.ConvTranspose2d(features[2], features[1], kernel_size=2, stride=2))
